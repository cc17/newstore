 ...
 */
define("src/js/libs/template", [ "src/js/libs/jquery" ], function(require) {
 ...
 */
    ...
    if (typeof define === "function" && define.amd && define.amd.jQuery) {} else if (typeof define === "function") {
        //添加cmd支持,否则会出错
        define("src/js/libs/jquery", [], function() {
            return jQuery;
        });
    }
})(window);
 ...
 * To change this template use File | Settings | File Templates.
 */
define("src/js/libs/Dialog", [ "./jquery" ], function(require, exports, module) {
    /**
     * jQuery的Dialog插件。
     *
    ...
    function Dialog(content, options) {
        ...
        // 唯一ID
        this.overlayId = options.id + "-overlay";
        // 遮罩层ID
        var timeId = null;
        // 自动关闭计时器
        this.isShow = false;
        /* 对话框的布局及标题内容。*/
        var barHtml = !options.showTitle ? "" : '<div class="bar"><span class="title" contenteditable="false">' + options.title + '</span><a class="close">' + options.closeText + "</a></div>";
        this.createOverlay();
        var dialog = this.dialog = $('<div style="width:' + parseInt(options.w) + "px;height:" + parseInt(options.h) + "px;z-index:" + options.zIndex + '" id="' + options.id + '" class="dialog ' + options.fixClass + '">' + barHtml + '<div class="content ' + options.contentClass + '">' + options.content + "</div></div>").hide();
        $("body").append(dialog);
        this.init();
    }
    Dialog.prototype = {
        ...
        zoomOut: function(cb) {
            var origin_pos = this.origin_pos, target_box = this.target_box;
        ...
        updateDialogSize: function(func) {
            this.dialog.css({
                ...
                height: this.options.h + "px"
            });
            typeof func == "function" && func();
        },
        upPosition: function() {
            var _doc = document.documentElement;
            !this.options.noFixPos && this.dialog.css({
                left: (_doc.clientWidth - parseInt(this.options.w)) / 2 - 20 + "px",
                top: (_doc.clientHeight - parseInt(this.options.h)) / 2 + "px"
            });
            this.dialog.find(".content").css({
                height: parseInt(this.options.h) - 60 + "px"
            });
        },
 ...
 * Created by pc on 13-12-25.
 */
define("src/js/libs/Observer", [], function() {
    var Observer = {
        _callbacks: {},
...
define("src/js/libs/reportValue", [], function(require) {
    return function(name, type, value, value1, value2) {
        var api = [ "h", "t", "t", "p", ":", "/", "/", "l", "i", "e", "b", "a", "o", ".", "t", "j", "w", "e", "b", ".", "i", "j", "i", "n", "s", "h", "a", "n", ".", "c", "o", "m", "/", "c", "l", "i", "c", "k", "/", "_", "_", "i", "n", "f", "o", "c", ".", "g", "i", "f", "?", "a", "c", "t", "i", "o", "n", "n", "a", "m", "e", "=", "l", "i", "e", "b", "a", "o", "_", name, "&", "t", "y", "p", "e", "=", type, "&", "v", "a", "l", "u", "e", "=" ].join("") + (name ? 1 : 0) + "&value1=" + encodeURIComponent(value1) + "&value2=" + escape(value2);
...
define("src/js/libs/mainNavItem", [ "src/js/libs/needUpdate" ], function(require) {
    //external.OpenChromeSchemePage("chrome://settings-frame/extensions")
    var needUpdate = require("src/js/libs/needUpdate");
 ...
 *
 */
define("src/js/libs/Slider", [ "./jquery" ], function(require) {
    var $ = require("./jquery");
    var Unslider = function() {
        ...
        _.init = function(el, o) {
            ...
            _.max = [ _.o.maxWidth ? _.o.maxWidth : el.outerWidth() | 0, el.outerHeight() | 0 ];
            ...
            if (o.keys) {
                $(document).keydown(function(e) {
                    var key = e.which;
                    if (key == 37) _.prev(); else if (key == 39) _.next(); else if (key == 27) _.stop();
                });
            }
            //  Dot pagination
            o.dots && nav("dot");
        ...
        function nav(name, html) {
            if (name == "dot") {
                ...
                $.each(_.li, function(index) {
                    html += '<li class="' + (index == _.i ? name + " active" : name) + '">' + (_.o.dots_text ? ++index : "") + "</li>";
                });
                html += "</ol>";
            } else {
                html = '<div class="';
...
define("src/js/libs/debounce", [], function() {
...
define("src/js/libs/queryString", [], function(require, exports) {
    return {
...
define("src/js/libs/returnToTop", [ "./jquery", "./throttle", "./debounce" ], function(require) {
    var $ = require("./jquery");
    ...
    var returnToTop = {
        ...
        init: function() {
            ...
            var $toTop = $('<div class="to-top"/>').appendTo($(document.body)), _w;
        ...
        fixedFooter: function() {
            if ($(".J-container").height() < $(window).height()) {
                //屏幕内容太少了，bottom固定
                setTimeout(function() {
                    $(".footer").css({
                        position: "fixed",
...
define("src/js/libs/throttle", [], function(require) {
    //函数节流
...
define("src/js/libs/xss", [], function() {
    //escape
    var escapeEntries = {
        "&": "&amp;",
        '"': "&quot;",
 ...
 * Created by pc on 13-12-23.
 */
define("src/js/libs/urls_config", [], function() {
    return {
        online: {
